...
const ExportDataPanel: React.FC<{
    isExporting: boolean,
    maxPage: number,
    total: number,
    size: number,
    ...
    const items: TabType[] = [
        {
            label: <>信息系统</>,
            key: "site",
            children: <SiteTabContent ref={ref.site}/>,
            closable: false,
            forceRender: true
        },
        {
            label: <>域名</>,
            key: "domain",
            children: <DomainTabContent ref={ref.domain}/>,
            closable: false,
            forceRender: true
        },
        // { label: <>移动端应用</>, key: "apk", children: <ApkTabContent ref={ref.apk} />, closable: false, forceRender: true },
        {
            label: <>人员</>,
            key: "member",
            children: <MemberTabContent ref={ref.member}/>,
            closable: false,
            forceRender: true
        },
        {
            label: <>邮箱</>,
            key: "email",
            children: <EmailTabContent ref={ref.email}/>,
            closable: false,
            forceRender: true
        },
    ...
    const [columns, setColumns] = useState<ColumnsType<zone.SiteItem>>([
        ...
        },
        {
            ...
            onCell: (record, index) => {
                return {
                    onContextMenu: () => {
                        selectedRow.current = {item: record, rowIndex: index, colKey: "url",};
                    },
        ...
        },
        {
            ...
            onCell: (record, index) => {
                return {
                    onContextMenu: () => {
                        selectedRow.current = {item: record, rowIndex: index, colKey: "ip",};
                    },
        ...
        },
        {
            ...
            onCell: (record, index) => {
                return {
                    onContextMenu: () => {
                        selectedRow.current = {item: record, rowIndex: index, colKey: "port",};
                    },
        ...
        },
        {
            ...
            ellipsis: true,
            width: 400,
            sorter: ((a, b) => localeCompare(a.title, b.title)),
            onCell: (record, index) => {
                return {
                    onContextMenu: () => {
                        selectedRow.current = {item: record, rowIndex: index, colKey: "title",};
                    },
        ...
        // },
        {
            ...
            ellipsis: true,
            width: 80,
            sorter: ((a, b) => localeCompare(a.cms, b.cms)),
            onCell: (record, index) => {
                return {
                    onContextMenu: () => {
                        selectedRow.current = {item: record, rowIndex: index, colKey: "cms",};
                    },
        ...
        // { title: '省份', dataIndex: "province", ellipsis: true, width: 60, },
        {
            ...
            onCell: (record, index) => {
                return {
                    onContextMenu: () => {
                        selectedRow.current = {item: record, rowIndex: index, colKey: "city",};
                    }
                }
            }
        },
        {
            ...
            ellipsis: true,
            width: 100,
            sorter: ((a, b) => localeCompare(a.operator, b.operator)),
            onCell: (record, index) => {
                return {
                    onContextMenu: () => {
                        selectedRow.current = {item: record, rowIndex: index, colKey: "operator",};
                    }
                }
            }
        },
        ...
        // { title: 'HTML_Banner', dataIndex: "html_banner", ellipsis: true, width: 60, },
        {
            ...
            ellipsis: true,
            width: 200,
            sorter: ((a, b) => localeCompare(a.group, b.group)),
            onCell: (record, index) => {
                return {
                    onContextMenu: () => {
                        selectedRow.current = {item: record, rowIndex: index, colKey: "group",};
                    }
                }
            }
        },
        {
            ...
            ellipsis: true,
            width: 200,
            sorter: ((a, b) => localeCompare(a.beian, b.beian)),
            onCell: (record, index) => {
                return {
                    onContextMenu: () => {
                        selectedRow.current = {item: record, rowIndex: index, colKey: "beian",};
                    }
                }
            }
        },
        {
            ...
            ellipsis: true,
            width: 80,
            sorter: ((a, b) => localeCompare(a.is_cdn, b.is_cdn)),
            render: (text) => text === 0 ? "否" : "是",
            onCell: (record, index) => {
                return {
                    onContextMenu: () => {
                        selectedRow.current = {item: record, rowIndex: index, colKey: "is_cdn",};
                    }
                }
            }
        },
        {
            ...
            ellipsis: true,
            width: 80,
            sorter: ((a, b) => localeCompare(a.ssl_certificate, b.ssl_certificate)),
            onCell: (record, index) => {
                return {
                    onContextMenu: () => {
                        selectedRow.current = {item: record, rowIndex: index, colKey: "ssl_certificate",};
                    }
                }
            }
        },
        {
            ...
            ellipsis: true,
            width: 80,
            sorter: ((a, b) => localeCompare(a.service, b.service)),
            onCell: (record, index) => {
                return {
                    onContextMenu: () => {
                        selectedRow.current = {item: record, rowIndex: index, colKey: "service",};
                    }
                }
            }
        },
            ...
            <div>
                <Table
                    ...
                    footer={() => <div
                        ...
                        />
                        <ExportDataPanel isExporting={isExporting} maxPage={maxPage} total={total}
                                         size={currentPageSize} onOk={(page) => exportData(page)}/>
                    </div>}
                    onRow={(record) => {
                        return {
                            onContextMenu: (event) => {
...
const DomainTabContent = forwardRef((props, ref) => {
    const selectedRow = useRef<{
        item: zone.DomainItem | undefined,
        rowIndex: number | undefined,
        colKey: string | undefined
    }>({item: undefined, rowIndex: undefined, colKey: undefined})
    ...
    const [columns, setColumns] = useState<ColumnsType<zone.DomainItem>>([
        ...
        },
        {
            ...
            onCell: (record, index) => {
                return {
                    onContextMenu: () => {
                        selectedRow.current = {item: record, rowIndex: index, colKey: "company",};
                    },
        ...
        },
        {
            ...
            ellipsis: true,
            width: 200,
            sorter: ((a, b) => localeCompare(a.icp, b.icp)),
            onCell: (record, index) => {
                return {
                    onContextMenu: () => {
                        selectedRow.current = {item: record, rowIndex: index, colKey: "icp",};
                    },
...
const ApkTabContent = forwardRef((props, ref) => {
    ...
    const [columns, setColumns] = useState<ColumnsType<zone.ApkItem>>([
        ...
        },
        {
            ...
            ellipsis: true,
            width: 200,
            sorter: ((a, b) => localeCompare(a.source, b.source)),
            onCell: (record, index) => {
                return {
        ...
        },
        {
            ...
            dataIndex: "timestamp",
            ellipsis: true,
            sorter: ((a, b) => localeCompare(a.timestamp, b.timestamp)),
            onCell: (record, index) => {
                return {
            ...
            <Table
                ...
                footer={() => <div
                    ...
                    <Pagination
                        ...
                        onChange={(page, size) => handlePaginationChange(page, size)}
                    />
                    <ExportDataPanel isExporting={isExporting} maxPage={maxPage} total={total} size={currentPageSize}
                                     onOk={(page) => exportData(page)}/>
                </div>}
                sticky
                rowKey={"index"} //如果不为每个列数据添加一个key属性，则应该设置此项，这里设置为对应columns里序号的dataIndex值，参考【https://ant.design/components/table-cn#design-token #注意】
            />
    ...
    const [columns, setColumns] = useState<ColumnsType<zone.EmailItem>>([
        ...
        },
        {
            ...
            onCell: (record, index) => {
                return {
                    onContextMenu: () => {
                        selectedRow.current = {item: record, rowIndex: index, colKey: "email",};
                    },
        ...
        },
        {
            ...
            onCell: (record, index) => {
                return {
                    onContextMenu: () => {
                        selectedRow.current = {item: record, rowIndex: index, colKey: "source",};
                    },
        ...
        },
        {
            ...
            onCell: (record, index) => {
                return {
                    onContextMenu: () => {
                        selectedRow.current = {item: record, rowIndex: index, colKey: "timestamp",};
                    },
                    onClick: () => copy(record.timestamp)
                }
            }
...
const MemberTabContent = forwardRef((props, ref) => {
    ...
    const [columns, setColumns] = useState<ColumnsType<zone.MemberItem>>([
        ...
        },
        {
            title: '姓名', dataIndex: "name", ellipsis: true, width: 100, onCell: (record, index) => {
                return {
                    onContextMenu: () => {
                        selectedRow.current = {item: record, rowIndex: index, colKey: "name",};
                    },
        ...
        },
        {
            ...
            ellipsis: true,
            width: 200,
            render: (text, record: ZoneMemberItemType, index) => record.position?.join(" "),
            onCell: (record, index) => {
                return {
                    onContextMenu: () => {
                        selectedRow.current = {item: record, rowIndex: index, colKey: "position",};
                    },
        ...
        },
        {
            title: '简介', dataIndex: "introduction", ellipsis: true, width: 200, onCell: (record, index) => {
                return {
                    onContextMenu: () => {
                        selectedRow.current = {item: record, rowIndex: index, colKey: "introduction",};
                    },
    ...
    const dispatch = useDispatch()
    const selectedRow = useRef<{
        item: zone.MemberItem | undefined,
        rowIndex: number | undefined,
        colKey: string | undefined
    }>({item: undefined, rowIndex: undefined, colKey: undefined})
    const [isExporting, setIsExporting] = useState<boolean>(false)
...
const CodeTabContent = forwardRef((props, ref) => {
    ...
    const MyItem: React.ForwardRefRenderFunction<HTMLDivElement, { line: string, index: number } & {
        ...
        <div style={{display: 'flex', flexDirection: 'column', height: '100%'}}>
            <Spin
                            ...
                            <AdList
                                ...
                                renderItem={(item, index) => {
                                    ...
                                    const codeSlice: {
                                        index: number,
                                        line: string
                                    }[] = tmp.map((line: string, index: number) => {
                                            ...
                                            <Space direction='vertical' style={{width: "100%"}}>
                                                <Space wrap style={{width: "100%"}}>
                                                    <span style={{
                                                        ...
                                                        <Tag bordered={false}
                                                             color="cyan">序号:{(currentPage - 1) * currentPageSize + index + 1}</Tag>
                                                    ...
                                                    <Tag bordered={false}>类型: {item.type}</Tag>
                                                    {
                                                        ...
                                                        <Tag bordered={false}>创建时间: {item.created_time}</Tag>
                                                    }
                                                    {
                                                        item.owner.login !== "" &&
                                                        <Tag bordered={false}>作者: {item.owner.login}</Tag>
                                                    }
                                                    {
                                                        item.file_extension !== "" &&
                                                        <Tag bordered={false}>FileExt: {item.file_extension}</Tag>
                                                    }
                                                    {
                                                        item.source !== "" &&
                                                        <Tag bordered={false}>来源: {item.source}</Tag>
                                                    }
                                                    <Tag bordered={false}>收录时间: {item.timestamp}</Tag>
                                                    {
                                                        item.related_company && item.related_company?.length > 0 &&
                                                        <Tag bordered={false}
                                                             color="red">关联企业: {item.related_company.join("、")}</Tag>
                                                    }
                                                    {
                                                        ops?.length > 0 && (
                                                            <>
                                                                    ...
                                                                    ops.map((option, index) => (
                                                                        ...
                                                                        >
                                                                            <Popover
                                                                                title={<>
                                                                                    {option.label}
                                                                                    <Copy size='small' type='link'
                                                                                          title={'复制'} placement={'right'}
                                                                            ...
                                                                            >
                                                                                <Badge count={option.badgeCount}
                                                                                       size="small" offset={[-10, 0]}>
                                                                                    <Tag bordered={false}>
                                                                                        {option.label}
                                                                                    </Tag>
                                                                                </Badge>
                ...
                <footer style={{
                    ...
                    />
                    <ExportDataPanel isExporting={isExporting} maxPage={maxPage} total={total} size={currentPageSize}
                                     onOk={(page: number) => exportData(page)}/>
                </footer>
            </Spin>
        </div>
    )
                                        ...
                                        >
                                            <Space direction='vertical' style={{width: "100%"}}>
                                                <Space wrap style={{width: "100%"}}>
                                                    <Tag bordered={false}
                                                         color="cyan">序号:{(currentPage - 1) * currentPageSize + index + 1}</Tag>
                                                    <Tooltip title={item.title} placement="bottom" destroyTooltipOnHide
                                                             overlayStyle={{maxWidth: '1000px'}}>
                                                        <span
                                                            style={{
                                                                display: "block",
                                                    ...
                                                    {item.msg?.title_cn &&
                                                        <Tag bordered={false} color='red'>{item.msg.title_cn}</Tag>}
                                                    <Tag bordered={false} color="red">
                                                        热度: {item.hot}
                                                    </Tag>
                                                    {item.industry && item.industry.length > 0 &&
                                                        <Tag bordered={false}>行业: {item.industry.join(" ")}</Tag>}
                                                    {location.length > 0 &&
                                                        <Tag bordered={false}>地区: {location.join(" ")}</Tag>}
                                                    {item.language && item.language.length > 0 &&
                                                        <Tag bordered={false}>语言: {item.language.join(" ")}</Tag>}
                                                    {item.msg.author && item.msg.author !== "" &&
                                                        <Tag bordered={false}>作者: {item.msg.author}</Tag>}
                                                    <Tag bordered={false}>类型: {item.event.join(" ")}</Tag>
                                                    {item.msg?.price &&
                                                        <Tag bordered={false}>售价: {item.msg.price}</Tag>}
                                                    {item.msg.num_sales !== undefined &&
                                                        <Tag bordered={false}>已售: {item.msg.num_sales}</Tag>}
                                                </Space>
                                                {
                                                            ...
                                                            {ops?.length > 0 && (
                                                                <>
                                                                    {ops.map((option, index) => (
                                                                            ...
                                                                            content={<div style={{
                                                                                ...
                                                                                <AdList
                                                                                    ...
                                                                                    renderItem={(item: {
                                                                                        ...
                                                                                        <AdList.Item key={item.key} style={{
                                                                                            padding: 0,
                                                                                            whiteSpace: "nowrap"
                                                                                        }}>
                                                                                            {item.value}
                                                                        ...
                                                                        >
                                                                            <Badge count={option.badgeCount} size="small"
                                                                                   offset={[-10, 0]}>
                                                                                <Tag bordered={false}>
                                                                                    {option.label}
                                                                                </Tag>
                                                ...
                                                <span>
                                                    ...
                                                    <Tag bordered={false}
                                                         color='orange'>发布时间: {item.msg.release_time}
                                                    </Tag>
                                                    <Tag bordered={false}
                                                         color='orange'>收录时间: {item.update_time}</Tag>
                                                </span>
                                                {
                                                    item.msg?.description &&
                                                    <span><Tag bordered={false}
                                                               color="cyan">简评: </Tag><span>{item.msg.description}</span></span>
                                                }
...
const exampleHelpDataTabs: TabsProps['items'] = [
    {
        key: "1",
        label: "操作符列表",
        children: <Table scroll={{y: 450}} size='small' pagination={false} columns={exampleHelpColumns1}
                         dataSource={[
                             {
                             ...
                             },
                             {
                                 index: 3,
                                 field: "()",
                                 description: "条件分组，条件可以使用括号括起来确定优先级，如：(company==学院||company==学校)&&(name==李)"
                             },
                             {
                         ...
                         dataSource={[
                             {
                                 index: 1,
                                 field: "title",
                                 description: `从信息系统中搜索「网页标题」情报 "如：xxx标题" 的数据，如：title==情报`
                             },
                             {
                                 index: 2,
                                 field: "company",
                                 description: `从信息系统中搜索「所属公司」包含 "如：xxx网络科技" 的数据，如：group==网络科技`
                             },
                             {
                                 index: 3,
                                 field: "html_banner",
                                 description: `从信息系统中搜索「HTML原文」包含 "如：零零信安" 的数据，如：html_banner==零零信安`
                             },
                             {
                                 index: 4,
                                 field: "ip",
                                 description: `从信息系统中搜索「IP或IP段」等于 "如：10.0.0.1、10.0.0.1/24、10.0.0.1-10.0.0.34" 的数据，如：ip=39.98.171.0-39.98.171.254`
                             },
                             {
                                 index: 5,
                                 field: "url",
                                 description: `从信息系统中搜索「URL」包含 "如：00sec.com" 的数据，如：url==00sec.com`
                             },
                             {
                                 index: 6,
                                 field: "banner",
                                 description: `从信息系统中搜索「端口返回信息」包含 "如：零零信安" 的数据，如：banner==零零信安`
                             },
                             {
                                 index: 7,
                                 field: "tags",
                                 description: `从信息系统中搜索「标签」包含 "如：登录" 的数据，如：tags==登录`
                             },
                             {
                                 index: 8,
                                 field: "port",
                                 description: `从信息系统中搜索「端口」等于 "如：80" 的数据，如：port=443`
                             },
                             {
                                 index: 9,
                                 field: "component",
                                 description: `从信息系统中搜索「组件」包含 "如：nginx" 的数据，如：component==nginx`
                             },
                             {
                                 index: 10,
                                 field: "service",
                                 description: `从信息系统中搜索「服务」包含 "如：http" 的数据，如：service==http`
                             },
                             {
                                 index: 11,
                                 field: "os",
                                 description: `从信息系统中搜索「操作系统」包含 "如：Linux" 的数据，如：os==windows`
                             },
                             {
                                 index: 12,
                                 field: "extra_info",
                                 description: `从信息系统中搜索「设备分类」包含 "如：负载均衡" 的数据，如：extra_info==负载均衡`
                             },
                             {
                                 index: 13,
                                 field: "app_name",
                                 description: `从信息系统中搜索「APP名称」包含 "如：零零信安" 的数据，如：app_name==零零信安`
                             },
                             {
                                 index: 14,
                                 field: "status_code",
                                 description: `从信息系统中搜索「状态码」等于 "如：200" 的数据，如：status_code=200`
                             },
                             {
                                 index: 15,
                                 field: "operator",
                                 description: `从信息系统中搜索「运营商」包含 "如：电信" 的数据，如：operator==电信`
                             },
                             {
                                 index: 16,
                                 field: "device_type",
                                 description: `从信息系统中搜索「设备」包含 "如：load balancer" 的数据，如：device_type==balancer`
                             },
                             {
                                 index: 17,
                                 field: "versions",
                                 description: `从信息系统中搜索「版本」包含 "如：1.0" 的数据，如：1.0`
                             },
                             {
                                 index: 18,
                                 field: "cms",
                                 description: `从信息系统中搜索「CMS」包含 "如：WordPress" 的数据，如：cms==WordPress`
                             },
                             {
                                 index: 19,
                                 field: "cdn",
                                 description: `从信息系统中搜索「CDN」等于 "如：0" 的数据，如：cdn=1`
                             },
                             {
                                 index: 20,
                                 field: "put_record",
                                 description: `从信息系统中搜索「备案号」包含 "如：备xxx" 的数据，如：put_record==2022`
                             },
                             {
                                 index: 21,
                                 field: "lang",
                                 description: `从信息系统中搜索「开发语言」包含 "如：java" 的数据，如：lang==java`
                             },
                             {
                                 index: 22,
                                 field: "explore_timestamp",
                                 description: `从信息系统中搜索「录入时间」包含 "week代表查看最近7天" 的数据，如：explore_timestamp==week`
                             }, {
                                 index: 23,
                                 field: "timestamp",
                                 description: `从信息系统中搜索「更新时间」 "week=7天内更新,month=1个月内更新 ,six_month=6个月内更新,min_six_month=6个月前更新 " 的数据，如：`
                             },
                             {
                                 index: 24,
                                 field: "country",
                                 description: `从信息系统中搜索「国家」包含 "如：美国" 的数据，如：country==美国`
                             },
                             {
                                 index: 25,
                                 field: "province",
                                 description: `从信息系统中搜索「省」包含 "如：四川" 的数据，如：province==四川`
                             },
                             {
                                 index: 26,
                                 field: "city",
                                 description: `从信息系统中搜索「市」包含 "如：北京" 的数据，如：city==北京`
                             },
                             {
                                 index: 27,
                                 field: "ssl_info.detail",
                                 description: `从信息系统中搜索「SSL证书详情」 "如：零零信安" 的数据，如：`
                             },
                             {
                                 index: 28,
                                 field: "asset_type",
                                 description: `从信息系统中搜索「资产类型」包含 "如：其他设备:asset_type=ip,网站系统asset_type=operating" 的数据，如：`
                             },
                             {
                                 index: 29,
                                 field: "ssl_info.issuer_cn",
                                 description: `从信息系统中搜索「SSL书颁发者公共名」包含 "如：Amazon" 的数据，如：ssl_info.issuer_cn==Amazon`
                             },
                             {
                                 index: 30,
                                 field: "ssl_info.issuer_org",
                                 description: `从信息系统中搜索「SSL证书颁发者机构名」包含 "如：Amazon" 的数据，如：ssl_info.issuer_org==Amazon`
                             },
                             {
                                 index: 31,
                                 field: "ssl_info.subject_cn",
                                 description: `从信息系统中搜索「SSL证书公用名」包含 "如：management" 的数据，如：ssl_info.subject_cn==management`
                             },
                             {
                                 index: 32,
                                 field: "ssl_info.subject_org",
                                 description: `从信息系统中搜索「SSL证书机构名」包含 "如：DataDomain" 的数据，如：ssl_info.subject_org==DataDomain`
                             },
                         ...
                         dataSource={[
                             {
                                 index: 1,
                                 field: "title",
                                 description: `从移动端应用中搜索「应用名称」包含 "如：万能" 的数据，如：title==万能`
                             },
                             {
                                 index: 2,
                                 field: "description",
                                 description: `从移动端应用中搜索「应用描述」包含 "如：去水印" 的数据，如：description==去水印`
                             },
                             {
                                 index: 3,
                                 field: "group",
                                 description: `从移动端应用中搜索「集团公司」包含 "如：xxx网络科技" 的数据，如：group==网络科技`
                             },
                             {
                                 index: 4,
                                 field: "company",
                                 description: `从移动端应用中搜索「所属公司」包含 "如：xxx网络科技" 的数据，如：company==网络科技`
                             },
                             {
                                 index: 5,
                                 field: "type",
                                 description: `从移动端应用中搜索「应用类型」等于 "如：微信小程序、微信公众号" 的数据，如：type=微信小程序`
                             },
                             {
                                 index: 6,
                                 field: "source",
                                 description: `从移动端应用中搜索「来源」等于 "如：wx.qq.com" 的数据，如：source=wx.qq.com`
                             },
                         ...
                         dataSource={[
                             {
                                 index: 1,
                                 field: "company",
                                 description: `从域名中搜索「所属公司」包含 "如：xxx网络科技" 的数据，如：company==网络科技`
                             },
                             {
                                 index: 2,
                                 field: "domain",
                                 description: `从域名中搜索「根域名」逐字匹配 "如：00sec.com" 的数据，如：domain===00sec.com`
                             },
                             {
                                 index: 3,
                                 field: "url",
                                 description: `从域名中搜索「子域名」逐字匹配 "如：00sec.com" 的数据，如：url===00sec.com`
                             },
                             {
                                 index: 4,
                                 field: "icp",
                                 description: `从域名中搜索「备案号」逐字匹配 "如：备2022" 的数据，如：icp===备2022`
                             },
                             {
                                 index: 5,
                                 field: "toplv_domain",
                                 description: `从域名中搜索「域名后缀」包含 "如 com、cn、net、org等" 的数据，如：toplv_domain==org`
                             },
                             {
                                 index: 6,
                                 field: "title",
                                 description: `从域名中搜索「网页标题」包含 "如：数据" 的数据，如：title==数据`
                             },
                             {
                                 index: 7,
                                 field: "level",
                                 description: `从域名中搜索「域名级别」等于 "如：子域名" 的数据，如：level=子域名`
                             },
                         ...
                         dataSource={[
                             {
                                 index: 1,
                                 field: "email_domain",
                                 description: `从邮箱中搜索「邮箱域名」逐字匹配 "如：126.com" 的数据，如：email_domain===126.com`
                             },
                             {
                                 index: 2,
                                 field: "email_type",
                                 description: `从邮箱中搜索「邮箱类型」等于 "如：企业邮箱" 的数据，如：企业邮箱`
                             },
                             {
                                 index: 3,
                                 field: "email",
                                 description: `从邮箱中搜索「邮箱地址」逐字匹配 "如：@126.com" 的数据，如：email===@126.com`
                             },
                             {
                                 index: 4,
                                 field: "group",
                                 description: `从邮箱中搜索「集团公司」包含 "如：xxx网络科技" 的数据，如：group==网络科技`
                             },
                             {
                                 index: 5,
                                 field: "company",
                                 description: `从邮箱中搜索「所属公司」包含 "如：xxx网络科技" 的数据，如：company==网络科技`
                             },
                             {
                                 index: 6,
                                 field: "leakage_num",
                                 description: `从邮箱中搜索「泄露次数」等于 "如：4" 的数据，如：leakage_num=4`
                             },
                             {
                                 index: 7,
                                 field: "source",
                                 description: `从邮箱中搜索「来源」等于 "如：0.zone" 的数据，如：source=0.zone`
                             },
                             {
                                 index: 8,
                                 field: "msg.tags",
                                 description: `从邮箱中搜索「标签」包含 "如：科技有限公司" 的数据，如：msg.tags==科技有限公司`
                             },
                         ]}
        />
    },
                         ...
                         dataSource={[
                             {
                                 ...
                                 description: `从代码/文档中搜索「关联公司」包含"如：xxx网络科技"的数据，如：related_company==网络科技`
                             },
                             {
                                 index: 2,
                                 field: "suffix",
                                 description: `从代码/文档中搜索「文件后缀」等于"如：js、java、html"的数据，如：suffix=html`
                             },
                             {
                                 index: 3,
                                 field: "code_detail",
                                 description: `从代码/文档中搜索「代码/文档原文」包含"如：password"的数据，如：code_detail==password`
                             },
                             {
                                 index: 4,
                                 field: "repository.description",
                                 description: `从代码/文档中搜索「仓库描述」包含"如:爬虫"的数据，如：repository.description==爬虫`
                             },
                             {
                                 index: 5,
                                 field: "source",
                                 description: `从代码/文档中搜索「来源」等于"如：csdn.net"的数据，如：source=csdn.net`
                             },
                             {
                                 index: 6,
                                 field: "tags",
                                 description: `从代码/文档中搜索「标签」包含"如：密码"的数据，如：tags==密码`
                             },
                             {
                                 index: 7,
                                 field: "url",
                                 description: `从代码/文档中搜索「代码URL」包含"如：metinfo"的数据，如：url==metinfo`
                             },
                             {
                                 index: 8,
                                 field: "type",
                                 description: `从代码/文档中搜索「类型」等于"如：代码、文档"的数据，如：type=文档`
                             },
                             {
                                 index: 9,
                                 field: "keyword",
                                 description: `从代码/文档中搜索「关键词」包含"如：文档中的域名、手机号、密码等"的数据，如：keyword==手机号`
                             },
                             {
                                 index: 10,
                                 field: "detail_parsing.domain_list",
                                 description: `从代码/文档中搜索「涉及域名」包含"如：gmail.com"的数据，如：detail_parsing.domain_list==gmail.com`
                             },
                             {
                                 index: 11,
                                 field: "detail_parsing.ip_list",
                                 description: `从代码/文档中搜索「涉及IP」包含"如：39.98"的数据，如：detail_parsing.ip_list==39.98`
                             },
                             {
                                 index: 12,
                                 field: "detail_parsing.email_list",
                                 description: `从代码/文档中搜索「涉及邮箱」包含"如：163.com"的数据，如：detail_parsing.email_list==163.com`
                             },
                             {
                                 index: 13,
                                 field: "detail_parsing.telegram_list",
                                 description: `从代码/文档中搜索「涉及telegram账号」包含"如：data"的数据，如：detail_parsing.telegram_list==data`
                             },
                         ]}
        />
    },
                         ...
                         dataSource={[
                             {
                                 index: 1,
                                 field: "company",
                                 description: `从人员中搜索「所属公司」包含"如：xxx网络科技"的数据，如：company==网络科技`
                             },
                             {
                                 index: 2,
                                 field: "name",
                                 description: `从人员中搜索「姓名」逐字匹配"如：小冰"的数据，如：name===小冰`
                             },
                             {
                                 index: 3,
                                 field: "position",
                                 description: `从人员中搜索「职位」包含"如：法人"的数据，如：position==法人`
                             },
                             {
                                 index: 4,
                                 field: "msg.introduction",
                                 description: `从人员中搜索「公司简介」"如：xxx电子工程"的数据，如：msg.introduction==电子工程`
                             },
                             {
                                 index: 5,
                                 field: "source",
                                 description: `从人员中搜索「来源」"如：tianyancha.com"的数据，如：source=tianyancha.com`
                             },
                         ...
                         dataSource={[
                             {
                                 index: 1,
                                 field: "event",
                                 description: `从企业DWM情报中搜索「事件」包含"如：隐私"的数据，如：event==隐私`
                             },
                             {
                                 index: 2,
                                 field: "industry",
                                 description: `从企业DWM情报中搜索「行业」包含"如：金融"的数据，如：industry==金融`
                             },
                             {
                                 index: 3,
                                 field: "language",
                                 description: `从企业DWM情报中搜索「语言」包含"如：俄语"的数据，如：language==俄语`
                             },
                             {
                                 index: 4,
                                 field: "org",
                                 description: `从企业DWM情报中搜索「组织」包含"如：建设"的数据，如：org==建设`
                             },
                             {
                                 index: 5,
                                 field: "regions.country",
                                 description: `从企业DWM情报中搜索「国家」包含"如：美国"的数据，如：regions.country==美国`
                             },
                             {
                                 index: 6,
                                 field: "regions.province",
                                 description: `从企业DWM情报中搜索「省」包含"如：四川"的数据，如：regions.province==四川`
                             },
                             {
                                 index: 7,
                                 field: "regions.city",
                                 description: `从企业DWM情报中搜索「市」包含"成都"的数据，如：regions.city==成都`
                             },
                             {
                                 index: 8,
                                 field: "tags",
                                 description: `从企业DWM情报中搜索「标签」包含"如：黑客"的数据，如：tags==黑客`
                             },
                             {
                                 index: 9,
                                 field: "title",
                                 description: `从企业DWM情报中搜索「网页标题」包含"如：hacker"的数据，如：title==hacker`
                             },
                             {
                                 index: 10,
                                 field: "page_type",
                                 description: `从企业DWM情报中搜索「页面属性」包含"如：详情"的数据，如：page_type==详情`
                             },
                             {
                                 index: 11,
                                 field: "body",
                                 description: `从企业DWM情报中搜索「网页内容」包含"如：hacker"的数据，如：body==hacker`
                             },
                             {
                                 index: 12,
                                 field: "description",
                                 description: `从企业DWM情报中搜索「描述」包含"如：hacker"的数据，如：description==hacker`
                             },
                             {
                                 index: 13,
                                 field: "source",
                                 description: `从企业DWM情报中搜索「子域名」逐字匹配"如：hacker"的数据，如：source===hacker`
                             },
                             {
                                 index: 14,
                                 field: "root_domain",
                                 description: `从企业DWM情报中搜索「根域」逐字匹配"如：hacker"的数据，如：root_domain===hacker`
                             },
                             {
                                 index: 15,
                                 field: "msg.author",
                                 description: `从企业DWM情报中搜索「作者」逐字匹配"如：Anon"的数据，如：msg.author===Anon`
                             },
                             {
                                 index: 16,
                                 field: "detail_parsing.telegram_list",
                                 description: `从企业DWM情报中搜索「涉及telegram账号」包含"如：123"的数据，如：detail_parsing.telegram_list==123`
                             },
                             {
                                 index: 17,
                                 field: "detail_parsing.email_list",
                                 description: `从企业DWM情报中搜索「涉及邮箱」包含"如：gmail"的数据，如：detail_parsing.email_list==gmail`
                             },
                             {
                                 index: 18,
                                 field: "hot",
                                 description: `从企业DWM情报中搜索「数据价值」等于"如：1"的数据，如：hot=1`
                             },
                             {
                                 index: 19,
                                 field: "toplv_domain",
                                 description: `从企业DWM情报中搜索「顶级域名」等于"如：net"的数据，如：toplv_domain=net`
                             },
                         ]}
        />
    },
                         ...
                         dataSource={[
                             {
                                 index: 1,
                                 field: "chat_name",
                                 description: `从企业AIM情报中搜索「群名」包含"如：交易"的数据，如：chat_name==交易`
                             },
                             {
                                 index: 2,
                                 field: "message_time",
                                 description: `从企业AIM情报中搜索「时间」包含"如：2023-06-12"的数据，如：message_time==2023-06-12`
                             },
                             {
                                 index: 3,
                                 field: "sender_first_name",
                                 description: `从企业AIM情报中搜索「用户名称」包含"如：达摩"的数据，如：sender_first_name==达摩`
                             },
                             {
                                 index: 4,
                                 field: "content_text",
                                 description: `从企业AIM情报中搜索「内容」包含"如：今年"的数据，如：content_text==今年`
                             },
                             {
                                 index: 5,
                                 field: "event",
                                 description: `从企业AIM情报中搜索「事件」包含"如：隐私"的数据，如：event==隐私`
                             },
                             {
                                 index: 6,
                                 field: "industry",
                                 description: `从企业AIM情报中搜索「行业」包含"如：保险"的数据，如：industry==保险`
                             },
                             {
                                 index: 7,
                                 field: "org",
                                 description: `从企业AIM情报中搜索「涉及组织」包含"如：农业"的数据，如：org==农业`
                             },
                             {
                                 index: 8,
                                 field: "sender_phone",
                                 description: `从企业AIM情报中搜索「手机」逐字匹配"如：1231"的数据，如：sender_phone===1231`
                             },
                             {
                                 index: 9,
                                 field: "regions",
                                 description: `从企业AIM情报中搜索「涉及地区」包含"如：中国"的数据，如：regions==中国`
                             },
                             {
                                 index: 10,
                                 field: "sender_id",
                                 description: `从企业AIM情报中搜索「用户ID」逐字匹配"如：4012"的数据，如：sender_id===4012`
                             },
                             {
                                 index: 11,
                                 field: "sender_username",
                                 description: `从企业AIM情报中搜索「用户名称」逐字匹配"如：So"的数据，如：sender_username===So`
                             },
                             {
                                 index: 12,
                                 field: "file_extension",
                                 description: `从企业AIM情报中搜索「附件后缀名」等于"如：xlsx"的数据，如：file_extension=xlsx`
                             },
                             {
                                 index: 13,
                                 field: "hot",
                                 description: `从企业AIM情报中搜索「数据价值」等于"如：1"的数据，如：hot=1`
                             },
                         ]}
        />
    },
