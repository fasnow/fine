...
const IcpTask = React.forwardRef<IcpTaskProps,any>((props, ref) =>{
    ...
    const [columnDefs] = useState<ColDef[]>([
        ...
        { headerName: '添加时间', field: "createdAt", width: 180, valueFormatter(params: ValueFormatterParams) {
                return params.value && params.value.substring(0, 19)
            }},
    ]);
            ...
            <Flex vertical gap={10}>
                ...
                <Flex gap={5}>
                    ...
                    <TextArea
                        ...
                        style={{width: "100%"}} placeholder={"每行一个单位名称或域名或备案号查询，请勿使用子域名或者带http://www等字符的网址查询"}
                    />
                </Flex>
                <Flex align={"center"}>
                    ...
                    <Checkbox.Group
                        ...
                        onChange={(checkedValue)=>{setServiceTypes(checkedValue)}}
                    />
                </Flex>
            </Flex>
        </Modal>
